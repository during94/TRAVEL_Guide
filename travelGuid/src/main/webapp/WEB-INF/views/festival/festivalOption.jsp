...
<body>
<c:choose>
	<c:when test="${festival.f_kind eq '0'}">
		<td>지역 선택 : 지역 선택 : 
			<select name="f_kind">
	...
	<c:when test="${festival.f_kind eq '1'}">
		<td>지역 선택 : 
			<select name="f_kind">
	...
	<c:when test="${festival.f_kind eq '2'}">
		<td>지역 선택 : 
			<select name="f_kind">
				<option value="0">서울</option>
				<option value="1">부산</option>
	...
	<c:when test="${festival.f_kind eq '3'}">
		<td>지역 선택 : 
			<select name="f_kind">
				<option value="0">서울</option>
				<option value="1"  >부산</option>
	...
	<c:when test="${festival.f_kind eq '4'}">
		<td>지역 선택 : 
			<select name="f_kind">
				<option value="0">서울</option>
				<option value="1"  >부산</option>
	...
	<c:when test="${festival.f_kind eq '5'}">
		<td>지역 선택 : 
			<select name="f_kind">
				<option value="0">서울</option>
				<option value="1"  >부산</option>
	...
	<c:when test="${festival.f_kind eq '6'}">
		<td>지역 선택 : 
			<select name="f_kind">
				<option value="0">서울</option>
				<option value="1"  >부산</option>
	...
	<c:when test="${festival.f_kind eq '7'}">
		<td>지역 선택 : 
			<select name="f_kind">
				<option value="0">서울</option>
				<option value="1"  >부산</option>
	...
	<c:when test="${festival.f_kind eq '8'}">
		<td>지역 선택 : 
			<select name="f_kind">
				<option value="0">서울</option>
				<option value="1"  >부산</option>
	...
	<c:when test="${festival.f_kind eq '9'}">
		<td>지역 선택 : 
			<select name="f_kind">
				<option value="0">서울</option>
				<option value="1"  >부산</option>
	...
	<c:when test="${festival.f_kind eq '10'}">
		<td>지역 선택 : 
			<select name="f_kind">
				<option value="0">서울</option>
				<option value="1"  >부산</option>
	...
	<c:when test="${festival.f_kind eq '11'}">
		<td>지역 선택 : 
			<select name="f_kind">
				<option value="0">서울</option>
				<option value="1"  >부산</option>
	...
	<c:when test="${festival.f_kind eq '12'}">
		<td>지역 선택 : 
			<select name="f_kind">
				<option value="0">서울</option>
				<option value="1"  >부산</option>
	...
	<c:when test="${festival.f_kind eq '13'}">
		<td>지역 선택 : 
			<select name="f_kind">
				<option value="0">서울</option>
				<option value="1"  >부산</option>
	...
	<c:when test="${festival.f_kind eq '14'}">
		<td>지역 선택 : 
			<select name="f_kind">
				<option value="0">서울</option>
				<option value="1"  >부산</option>
	...
	<c:when test="${festival.f_kind eq '15'}">
		<td>지역 선택 : 
			<select name="f_kind">
				<option value="0">서울</option>
				<option value="1"  >부산</option>
	...
	<c:when test="${festival.f_kind eq '16'}">
		<td>지역 선택 : 
			<select name="f_kind">
				<option value="0">서울</option>
				<option value="1"  >부산</option>
