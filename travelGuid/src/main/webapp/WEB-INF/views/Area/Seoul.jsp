...
<body>
	...
	<div id="sub_area" style="text-align: center">
	...
	<h3 style="text-align: center">서울 게시글</h3>
	<div class="search">
		<h3>
			게시글 검색:
	...
	<table class="content_table">
		...
		<p>
			<input type="button" value="글쓰기" onclick="location.href='go_Area_write?c_kind=0'">
