...
public class Kakao_login_api {
    ...
    public String getAccessToken (String authorize_code) {
        ...
        try {
            ...
            sb.append("&client_id=7b68723791293ec72aaf3bd575be4ee0");
            sb.append("&redirect_uri=http://localhost:8080/biz/social_login_kakao");
    ...
    public HashMap<String, Object> getUserInfo (String access_Token) {
        ...
        try {
            ...
            System.out.println("값 설정 properties : " + properties);
            ...
            userInfo.put("has_birthday", has_birthday);
            userInfo.put("has_gender", has_gender);
